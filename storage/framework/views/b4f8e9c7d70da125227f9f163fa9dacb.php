<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#show-btn', function() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('permission')); ?>/"+id,
                dataType: "JSON",
                success: function (response) {
            ...
            Swal.fire({
                ...
                .then((result) => {
                    if (result.value) {
                        ...
                        $.ajax({
                            'url': '<?php echo e(url('permission/deletes')); ?>',
                            'type': 'POST',
                            'data': {
        ...
        function getPermission() {
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('listPermission')); ?>",
                dataType: "JSON",
                success: function(response) {
                            ...
                            <?php if(Gate::check('permission_update') || Gate::check('permission_read')): ?>
                            {
                                ...
                                render: function(data, type, row, meta) {
                                    ...
                                    '<div class="d-flex justify-content-center">' +
                                        ...
                                        '</div>' +
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission_update')): ?>
                                        '<div class="col-6">' +
...
</script><?php /**PATH D:\Project\Laravel\article-website\resources\views/script/permission-script.blade.php ENDPATH**/ ?>