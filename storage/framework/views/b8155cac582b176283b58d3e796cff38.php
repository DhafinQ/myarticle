<script>
                ...
                Swal.fire({
                    ...
                    .then((result) => {
                        if (result.value) {
                            ...
                            $.ajax({
                                'url': '<?php echo e(url('role/deletes')); ?>',
                                'type': 'POST',
                                'data': {
    ...
    </script><?php /**PATH D:\Project\Laravel\article-website\resources\views/script/role-script.blade.php ENDPATH**/ ?>