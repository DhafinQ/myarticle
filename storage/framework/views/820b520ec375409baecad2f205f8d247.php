<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#show-btn', function() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('category')); ?>/"+id,
                dataType: "JSON",
                success: function (response) {
            ...
            Swal.fire({
                ...
                .then((result) => {
                    if (result.value) {
                        ...
                        $.ajax({
                            'url': '<?php echo e(url('category/deletes')); ?>',
                            'type': 'POST',
                            'data': {
        ...
        function getCategory() {
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('listCategory')); ?>",
                dataType: "JSON",
                success: function(response) {
                            ...
                            <?php if(Gate::check('category_update') || Gate::check('category_read')): ?>
                            {
                                ...
                                render: function(data, type, row, meta) {
                                    return type === 'display' ?
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('category_read')): ?>
...
</script><?php /**PATH D:\Project\Laravel\article-website\resources\views/script/category-script.blade.php ENDPATH**/ ?>