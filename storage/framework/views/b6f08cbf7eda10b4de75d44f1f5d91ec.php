        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list" id="sidebar">
                <ul class="navbar-nav iq-main-menu" id="sidebar">
                    <li class="nav-item">
                        <a class="nav-link 
                        <?php if(url()->current() === 'http://127.0.0.1:8000' || str_contains(url()->current(), 'article/show')): ?> active <?php endif; ?>
                        "
                    ...
                    <?php if(Gate::check('user_menu') || Gate::check('permission_menu') || Gate::check('role_menu')): ?>
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
                            <?php if(Gate::check('user_menu')): ?>
                            <li class="nav-item">
                                <a class="nav-link 
                                <?php if(str_contains(url()->current(), '/users')): ?> active <?php endif; ?>
                                "
                            ...
                            <?php endif; ?>
                            <?php if(Gate::check('permission_menu')): ?>
                            <li class="nav-item">
                                <a class="nav-link
                                <?php if(str_contains(url()->current(), '/permission')): ?> active <?php endif; ?>
                                "
                                    href="<?php echo e(url('permission')); ?>">
                                    P
                            ...
                            <?php endif; ?>
                            <?php if(Gate::check('role_menu')): ?>
                            <li class="nav-item">
                                <a class="nav-link
                                <?php if(str_contains(url()->current(), '/role')): ?> active <?php endif; ?>
                                "
                                    href="<?php echo e(url('role')); ?>">
                                    R
                    ...
                    <?php endif; ?>
                    <?php if(Gate::check('article_menu') || Gate::check('article_menu')): ?>
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar">
                            <?php if(Gate::check('category_menu')): ?>
                            <li class="nav-item">
                                <a class="nav-link 
                                <?php if(str_contains(url()->current(), '/category')): ?> active <?php endif; ?>
                                "
                            ...
                            <?php endif; ?>
                            <?php if(Gate::check('article_menu')): ?>
                            <li class="nav-item">
                                <a class="nav-link
                                <?php if(str_contains(url()->current(), '/article')): ?> active <?php endif; ?>
                                "
                                    href="<?php echo e(url('article')); ?>">
                                    MA
                    ...
                    <li class="nav-item">
                        <a class="nav-link 
                        <?php if(url()->current() === route('users.edits',auth()->user()->id)): ?> active <?php endif; ?>
                        "
                            aria-current="page" href="<?php echo e(route('users.edits',auth()->user()->id)); ?>">
                    ...
                    <ul class="navbar-nav ms-auto  navbar-list mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown"
                                ...
                                <img src="
                      <?php if(auth()->user()->foto_profile() == asset('storage/img_profile/')): ?> <?php echo e(asset('images/avatars/01.png')); ?>

                      <?php else: ?>
                      <?php echo e(auth()->user()->foto_profile()); ?> <?php endif; ?>
                    "
                                    alt="User-Profile" class="theme-color-default-img avatar avatar-50 avatar-rounded"
                                    style="object-fit: cover;">
                                <div class="caption ms-3 d-none d-md-block ">
                                    <h6 class="mb-0 caption-title"><?php echo e(auth()->user()->username); ?></h6>
                                    <p class="mb-0 caption-sub-title text-capitalize">
                                        <?php echo e(auth()->user()->getRoleNames()[0]); ?></p>
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<?php echo e(route('users.edits',auth()->user()->id)); ?>">Profile</a></li>
                                <li>
...
<?php /**PATH D:\Project\Laravel\article-website\resources\views/layouts/app.blade.php ENDPATH**/ ?>