                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                @foreach ($permissions as $p)
                                    <tr>
                                        <td><input type="checkbox" name="name[]" value="{{$p->name}}"></td>
                                        <td>{{$p->name}}</td>
                                        <td>{{$p->slug}}</td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                @foreach ($permissions as $p)
                                    <tr>
                                        <td><input type="checkbox" name="update_name[]" value="{{$p->name}}" id="{{'permission_name_'. $p->name}}"></td>
                                        <td>{{$p->name}}</td>
                                        <td>{{$p->slug}}</td>
                                    </tr>
                                @endforeach
