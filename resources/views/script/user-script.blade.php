    ...
    $(document).ready(function() {
                ...
                success: function(response) {
                    $table = $('#datatable2').DataTable({
                        ...
                        columns: [
                            ...
                            @endcan
                            @if (Gate::check('user_update') || Gate::check('user_read'))
                            {
                                'data': "id",
                    ...
                    $table = $('#datatable2').DataTable({
                        ...
                        'columnDefs': [
                        @if(Gate::check('user_show') || Gate::check('user_update'))
                            {
                                'targets': [1],
                                'orderable': false,
                            },
        ...
        $(document).on('click', '#show-btn', function() {
            ...
            $.ajax({
                ...
                dataType: "JSON",
                success: function(response) {
                    response.data.image_profile == null ? $('#profile_image').attr('src','{{asset('images/avatars/01.png')}}') : $('#profile_image').attr('src','{{asset('storage/img_profile/')}}/'+response.data.image_profile);
