                ...
                success: function (response) {
                    ...
                    $table = $('#datatable2').DataTable({
                        ...
                        columns: [
                            ...
                            {'data' : 'title'},
                            @endcan
                            @if (Gate::check('article_update') || Gate::check('article_read'))
                            {'data' : 'title'},
                            @endif
                            {'data' : 'title'},
                            {'data' : 'title'},
                        ...
                        columns: [
                            ...
                            '<div class="d-flex justify-content-center">'+
                                ...
                                '<div class="col-6 me-1">'+
                                    '<a class="btn btn-primary btn-sm" id="show-btn" href="{{url('article/show/')}}/'+data+'">'+
                                ...
                                @can('article_update')
                                '<div class="col-6">'+
                                    '<a class="btn btn-warning btn-sm" id="update-btn" href="{{url('article/edit')}}/'+data+'">'+
